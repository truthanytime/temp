                ...
                {friendList.map((value, index) => (
                    <div className="wrap" key={index}>
                        <div className="card-body d-flex pt-0 ps-4 pe-4 pb-0 bor-0">
                            <figure className="avatar me-3"><img src={`assets/images/${value.imageUrl}`} alt="avater" className="shadow-sm  w45" /></figure>
                            <h4 className="fw-700 text-grey-900 font-xssss mt-1">{value.name} <span className="d-block font-xssss fw-500 mt-1 lh-3 text-grey-500">{value.friend} agreed friends</span></h4>
                        </div>
