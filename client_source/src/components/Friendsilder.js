        ...
        return (
            <Slider {...friendsettings}>
                {memberList.map((value, index) => (
                    <div key={index} className="card w150 d-block border-0 shadow-xss rounded-xxl overflow-hidden mb-3 me-3">
                        <div className="card-body d-block bg-black w-100 pe-3 pb-4 text-center">
