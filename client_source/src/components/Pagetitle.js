            ...
            <div className="card shadow-xss w-100 d-block d-flex border-0 p-4 mb-3">
                ...
                <form action="#" className="pt-0 pb-0 ms-auto">
                    <div className="search-form-2 ms-2">
                        ...
                        <input type="text" value={searchword} onKeyDown={(e)=>keyPress(e.keyCode,e )} onChange={(e) => sendDataToParent(e.target.value)} className="form-control text-grey-500 mb-0 bg-greylight theme-dark-bg border-0" placeholder="Search here." />
                    </div>
                </form>
