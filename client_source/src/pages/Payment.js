                                ...
                                <div className="card-body p-lg-5 p-4 w-100 border-0">
                                    <div className="row">       
                                        ...
                                        {/* <div className="col-lg-5">
                                            ...
                                            <a href="/payment" className=" badge-pill border-dashed mb-2 p-3 w-100 fw-600 fw-700 text-center font-xssss mont-font text-uppercase ls-3 text-grey-900 d-block  text-dark">Add Card</a>
                                                    ...
                                                    <form>
                                                        ...
                                                        <div className="row">
                                                            ...
                                                            <div className="col-12">
                                                                <a href="/payment" className=" badge-pill bg-black mb-2 mt-4 p-3 w-100 fw-600 fw-700 text-center font-xssss mont-font text-uppercase ls-3 text-white d-block">Add Card</a>
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
