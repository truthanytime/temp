...
const Leftnav =()=> {
    return (
        <div className="navigation bg-black scroll-bar">
                ...
                <div className="nav-content">
                    <div className="nav-wrap bg-white bg-transparent-card rounded-xxl shadow-xss pt-3 pb-1 mb-2 mt-2">
                        ...
                        <ul className="mb-1 top-content">
                            ...
                            <li><Link to="/home" className="nav-content-bttn open-font"><i className="fas fa-home-alt"></i><span>HOME</span></Link></li>
                            <li><Link to="/myfeed" className="nav-content-bttn open-font"><i className="feather-user btn-round-md bg-primary-gradiant me-3"></i><span>Profile </span></Link></li>
